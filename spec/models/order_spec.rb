...
describe Order do
  ...
  describe '#set_total!' do
    ...
    it 'should returns the total amount to pay for the products' do
  ...
  describe '#build_placements_with_product_ids_and_quantities' do
    ...
    it 'should builds 2 placements for the order' do
  ...
  describe '#valid?' do
    ...
    it 'should becomes invalid due to insufficient products' do
